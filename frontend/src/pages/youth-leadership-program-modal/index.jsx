        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-heading font-bold text-primary mb-2">
              <TranslateText translationKey="kisanLeadershipProgram">Kisan Leadership Program</TranslateText>
            </h1>
            <p className="text-text-secondary font-body">
              <TranslateText translationKey="joinNextGeneration">Join our next generation of agricultural leaders</TranslateText>
            </p>
          </div>
